...
class ProgramInterface(Frame):
    def __init__(self):
        Frame.__init__(self)
        frame = Frame()
        self.master.title('Excel creator Anamita by RagonR')
        ...
        # Name in Empty line
        self.labEmpty = Label(frame, text="", bg="#F2F2F2", font=font11)
        self.labEmpty.grid(row=0, column=0, columnspan=2, sticky=W)

        # Country Names in interface

        # Name in UK
        self.labUK = Label(frame, text="English title:", bg="#F2F2F2", font=font11)
        ...
        # Name in DE
        self.labDE = Label(frame, text="German title:", bg="#F2F2F2", font=font11)
        ...
        # Name in FR
        self.labFR = Label(frame, text="Franch title:", bg="#F2F2F2", font=font11)
        ...
        # Name in IT
        self.labIT = Label(frame, text="Italian title:", bg="#F2F2F2", font=font11)
        ...
        # Name in ES
        self.labES = Label(frame, text="Spanish title:", bg="#F2F2F2", font=font11)
        ...
        self.MBV = IntVar()
        self.MBV.set(1)
        self.MBVbut = Checkbutton(frame, bg="#F2F2F2", text="MBV    ", variable=self.MBV, font=font11, onvalue=1,
                                  offvalue=0)
        ...
        self.MBM = IntVar()
        self.MBM.set(1)
        self.MBMbut = Checkbutton(frame, bg="#F2F2F2", text="MBM    ", variable=self.MBM, font=font11, onvalue=1,
                                  offvalue=0)
        ...
        self.MPV = IntVar()
        self.MPV.set(1)
        self.MPVbut = Checkbutton(frame, bg="#F2F2F2", text="MPV    ", variable=self.MPV, font=font11, onvalue=1,
                                  offvalue=0)
        ...
        self.MPM = IntVar()
        self.MPM.set(1)
        self.MPMbut = Checkbutton(frame, bg="#F2F2F2", text="MPM    ", variable=self.MPM, font=font11, onvalue=1,
                                  offvalue=0)
        ...
        self.MBK = IntVar()
        self.MBK.set(1)
        self.MBKbut = Checkbutton(frame, bg="#F2F2F2", text="MBK    ", variable=self.MBK, font=font11, onvalue=1,
                                  offvalue=0)
        ...
        self.MPK = IntVar()
        self.MPK.set(1)
        self.MPKbut = Checkbutton(frame, bg="#F2F2F2", text="MPK    ", variable=self.MPK, font=font11, onvalue=1,
                                  offvalue=0)
        ...
        self.SW = IntVar()
        self.SW.set(1)
        self.SWbut = Checkbutton(frame, bg="#F2F2F2", text="SW    ", variable=self.SW, font=font11, onvalue=1,
                                  offvalue=0)
        ...
        self.HO = IntVar()
        self.HO.set(1)
        self.HObut = Checkbutton(frame, bg="#F2F2F2", text="HO    ", variable=self.HO, font=font11, onvalue=1,
                                  offvalue=0)
        ...
        # MBV URL
        self.labMBV_URL = Label(frame, text="MBV URL:", bg="#F2F2F2", font=font11)
        ...
        # MBM URL
        self.labMBM_URL = Label(frame, text="MBM URL:", bg="#F2F2F2", font=font11)
        ...
        # MPV URL
        self.labMPV_URL = Label(frame, text="MPV URL:", bg="#F2F2F2", font=font11)
        ...
        # MPM URL
        self.labMPM_URL = Label(frame, text="MPM URL:", bg="#F2F2F2", font=font11)
        ...
        # MBK URL
        self.labMBK_URL = Label(frame, text="MBK URL:", bg="#F2F2F2", font=font11)
        ...
        # MPK URL
        self.labMPK_URL = Label(frame, text="MPK URL:", bg="#F2F2F2", font=font11)
        ...
        # SW URL
        self.labSW_URL = Label(frame, text="SW URL:", bg="#F2F2F2", font=font11)
        ...
        # HO URL
        self.labHO_URL = Label(frame, text="HO URL:", bg="#F2F2F2", font=font11)
        ...
        self.labnumber = Label(frame, text="Design number: ", bg="#F2F2F2", font=font11)
        ...
        def clickAdd(event):
            ...
            if int(self.MBV.get()) == 1:
                ...
                if MBV_URL == "https://www.dropbox.com/s/ibsqxpvt8qclz2z/vyriska_sizeguide.png?dl=0":
            ...
            if int(self.MBM.get()) == 1:
                ...
                if MBM_URL == "https://www.dropbox.com/s/dgkidatwk5bnsf6/moteriska_guide.png?dl=0":
            ...
            if int(self.MPV.get()) == 1:
                ...
                if MPV_URL == "https://www.dropbox.com/s/ibsqxpvt8qclz2z/vyriska_sizeguide.png?dl=0":
            ...
            if int(self.MPM.get()) == 1:
                ...
                if MPM_URL == "https://www.dropbox.com/s/dgkidatwk5bnsf6/moteriska_guide.png?dl=0":
            ...
            if int(self.MBK.get()) == 1:
                ...
                if MBK_URL == "https://www.dropbox.com/s/cahz4bi9vtzhezb/vaikiska_guide.png?dl=0":
            ...
            if int(self.MPK.get()) == 1:
                ...
                if MPK_URL == "https://www.dropbox.com/s/cahz4bi9vtzhezb/vaikiska_guide.png?dl=0":
            ...
            if int(self.SW.get()) == 1:
                ...
                if SW_URL == "https://www.dropbox.com/s/7seqlk7n7cw8qb8/vyriska_sweather-1.png?dl=0":
            ...
            if int(self.HO.get()) == 1:
                ...
                if HO_URL == "https://www.dropbox.com/s/rsf7nx3vc6oac5i/vyriska_hoodies.png?dl=0":
